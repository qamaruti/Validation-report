...
public class HomepageTest extends TestBase {
	...
	public void verifyOutboundPageTitle() {
		...
		System.out.print("Verified the label "+title2);
	...
	public void verifyInboundPageTitle() {
		...
		System.out.print("Verified the label "+title3);
	...
	public void verifyUsersandGroupsPageTitle() {
		...
		System.out.print("Verified the label "+title4);
	...
	public void verifyInventoryMaintainancePageTitle() {
		...
		System.out.print("Verified the label "+title5);
	...
	public void verifyUtilitiesPageTitle() {
		...
		System.out.print("Verified the label "+title6);
	...
	public void verifySelfserviceReportingPageTitle() {
		...
		System.out.print("Verified the label "+title7);
